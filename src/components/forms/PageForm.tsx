...
export function PageForm({ data, onChange }: PageFormProps) {
  ...
  return (
    <div className="p-6">
      <h2 className="text-lg font-semibold text-white mb-6">Add Page</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <h3 className="text-sm font-medium text-blue-900 mb-2">Gutenberg Block Support</h3>
          <p className="text-sm text-blue-700 mb-2">
            You can paste Gutenberg block markup directly into the content area. For example:
          </p>
          <code className="text-xs text-blue-600 bg-blue-100 p-2 rounded block">
            &lt;!-- wp:paragraph --&gt;<br/>
