        ...
        {tourMode !== 'none' && (
          <div style={{
            ...
            <p style={{ fontSize: 12, color: 'var(--text-tertiary)', margin: 0, lineHeight: 1.6 }}>
              Three files will be written to your Playground: <code>mu-plugins/pootle-tour.php</code>,{' '}
              <code>mu-plugins/pootle-tour.js</code>, and <code>uploads/pootle-tour.json</code>.
