...
const LINK_CLS = 'text-blue-500 hover:underline';

function ExtLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a href={href} {...EXT} className={LINK_CLS}>
      {children}
    </a>
  );
}
            ...
            <ul className='space-y-3 text-blueprint-text/80'>
              <li className='flex items-start gap-3'>
                ...
                <span>
                  ...
                  <ExtLink href='https://nodejs.org/'>Download here</ExtLink>
                  )
                </span>
              </li>
              <li className='flex items-start gap-3'>
                <span className='text-blueprint-accent mt-1'>•</span>
                <span>
                  <strong>Claude Desktop</strong> app (
                  <ExtLink href='https://claude.ai/download'>Download here</ExtLink>
                  )
                </span>
              </li>
            </ul>
